/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4a452c1f039c317f3f8229449a1fdf97)
// Runtime types generated with workerd@1.20260701.1 2026-07-05 nodejs_compat
interface __BaseEnv_Env {
	KIMI_IMPLEMENT_LABEL: "kimi-implement";
	LLM_PROVIDER: "moonshot";
	OPENHANDS_CONTAINER: DurableObjectNamespace<import("./src/worker").OpenHandsContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "OpenHandsContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KIMI_IMPLEMENT_LABEL" | "LLM_PROVIDER">> {}
}
